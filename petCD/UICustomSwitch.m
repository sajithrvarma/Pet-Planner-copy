...
+(UICustomSwitch *)switchWithLeftText:(NSString *)leftText andRight:(NSString *)rightText
{
	...
	switchView.leftLabel.textColor=[UIColor blackColor];
...
{
	if ((self=[super initWithFrame:CGRectMake(rect.origin.x,rect.origin.y,21,28)]))
	{
...
-(void)awakeFromNib
{
	...
	[self setThumbImage:[UIImage imageNamed:@"tog_button.png"] forState:UIControlStateNormal];
	[self setMinimumTrackImage:[UIImage imageNamed:@"togleft.png"] forState:UIControlStateNormal];
	[self setMaximumTrackImage:[UIImage imageNamed:@"togright.png"] forState:UIControlStateNormal];
	...
	self.leftLabel.frame = CGRectMake(0, 0, 48,26);
	...
	self.rightLabel.frame = CGRectMake(95, 0, 48,26);
...
-(void)setTintColor:(UIColor*)color
{
	if (color != tintColor)
	{
		...
		[self setMinimumTrackImage:[self image:[UIImage imageNamed:@"togright.png"] tintedWithColor:tintColor] forState:UIControlStateNormal];
	}
